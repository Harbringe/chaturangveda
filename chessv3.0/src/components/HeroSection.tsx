...
const stats = [
  ...
  { value: '3', label: 'FIDE-Rated Coaches' },
  ...
  return (
    <section id="hero" className={styles.hero}>
      ...
      <div className={styles.heroContent}>
        ...
        >
          Master Chess.<br /><span className={styles.highlight}>Master Life.</span>
        </motion.h1>
        ...
        >
          Expert chess coaching for kids by FIDE-rated coaches. From your child&apos;s first move to tournament glory — all online, all India.
        </motion.p>
